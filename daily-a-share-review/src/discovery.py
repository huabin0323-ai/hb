...
from src.fetcher import fetch_limit_up_pool, fetch_dragon_tiger, fetch_market_news, fetch_sector_spot
from src.hot_stocks import identify_hot_stocks
...
def compute_quick_filter(candidate: dict, limit_up_df=None) -> dict:
    ...
    dma = {}
    try:
        from src.fetcher import compute_dma_metrics
    ...
    val = {}
    try:
        from src.fetcher import fetch_valuation
